...
>
> PRD의 FR-01~12 각각을 기능별 상세 명세 파일로 분리하고, FR ↔ US ↔ 화면 ↔ API ↔ 백로그의 추적 관계를 이 문서에서 관리한다.
...
| FR-04 Template | [FR-04](개발문서/기능명세/FR-04_템플릿.md) | US-010 | S03·S04 (❓ 관리 화면 미정의) | `/templates` | P1 | BE-005 |
...
| 단계 | 현황 |
|---|---|
| 설계 | 12 / 12 — 전 FR이 PRD·US·API 초안에 반영됨 |
| 프로토타입 검증 | 부분 6 (FR-02·03·05·06·09·11) / 미검증 6 (FR-01·04·07·08·10·12) |
| 운영 구현 | 0 / 12 — 전체 미착수 (인프라 협의 중) |
...
- **P번호 주의**: 본 문서의 P단계는 [06_DEVELOPMENT_BACKLOG.md](개발문서/06_DEVELOPMENT_BACKLOG.md) 기준이다. 기획안 5절의 P번호 체계(P2=NH 업무자산, P3=AI 제작)와 다르다. `02_USER_STORIES_AC.md`에 있던 세 번째 P0~P3 우선순위 표기는 미사용 상태로 혼동만 유발해 폐기했다 — P단계는 항상 이 문서와 06 기준만 따른다.
