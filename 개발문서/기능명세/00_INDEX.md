...
>
> PRD의 FR-01~13 각각을 기능별 상세 명세 파일로 분리하고, FR ↔ US ↔ 화면 ↔ API ↔ 백로그의 추적 관계를 이 문서에서 관리한다.
...
| 단계 | 현황 |
|---|---|
| 설계 | 13 / 13 — 전 FR이 PRD·US·API 초안에 반영됨 |
| 프로토타입 검증 | 부분 8 (FR-02·03·04·05·06·09·11·13) / 미검증 5 (FR-01·07·08·10·12) |
| 운영 구현 | 0 / 13 — 전체 미착수 (인프라 협의 중) |
